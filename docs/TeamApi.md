...
------------- | ------------- | -------------
[**get_district_rankings_0**](TeamApi.md#get_district_rankings_0) | **GET** /district/{district_key}/rankings | 
[**get_district_teams_0**](TeamApi.md#get_district_teams_0) | **GET** /district/{district_key}/teams | 
[**get_district_teams_keys_0**](TeamApi.md#get_district_teams_keys_0) | **GET** /district/{district_key}/teams/keys | 
[**get_district_teams_simple_0**](TeamApi.md#get_district_teams_simple_0) | **GET** /district/{district_key}/teams/simple | 
[**get_event_teams_0**](TeamApi.md#get_event_teams_0) | **GET** /event/{event_key}/teams | 
[**get_event_teams_keys_0**](TeamApi.md#get_event_teams_keys_0) | **GET** /event/{event_key}/teams/keys | 
[**get_event_teams_simple_0**](TeamApi.md#get_event_teams_simple_0) | **GET** /event/{event_key}/teams/simple | 
[**get_event_teams_statuses_0**](TeamApi.md#get_event_teams_statuses_0) | **GET** /event/{event_key}/teams/statuses | 
...
[**get_team_events_statuses_by_year_0**](TeamApi.md#get_team_events_statuses_by_year_0) | **GET** /team/{team_key}/events/{year}/statuses | 
...
> Vec<models::DistrictRanking> get_district_rankings_0(district_key, if_none_match)
...
> Vec<models::Team> get_district_teams_0(district_key, if_none_match)
...
> Vec<String> get_district_teams_keys_0(district_key, if_none_match)
...
> Vec<models::TeamSimple> get_district_teams_simple_0(district_key, if_none_match)
...
> Vec<models::Team> get_event_teams_0(event_key, if_none_match)
...
> Vec<String> get_event_teams_keys_0(event_key, if_none_match)
...
> Vec<models::TeamSimple> get_event_teams_simple_0(event_key, if_none_match)
...
> std::collections::HashMap<String, models::GetTeamEventsStatusesByYear200ResponseValue> get_event_teams_statuses_0(event_key, if_none_match)
...
> std::collections::HashMap<String, models::GetTeamEventsStatusesByYear200ResponseValue> get_team_events_statuses_by_year_0(team_key, year, if_none_match)
