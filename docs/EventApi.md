...
------------- | ------------- | -------------
[**get_district_events_0**](EventApi.md#get_district_events_0) | **GET** /district/{district_key}/events | 
[**get_district_events_keys_0**](EventApi.md#get_district_events_keys_0) | **GET** /district/{district_key}/events/keys | 
[**get_district_events_simple_0**](EventApi.md#get_district_events_simple_0) | **GET** /district/{district_key}/events/simple | 
...
[**get_team_event_awards_0**](EventApi.md#get_team_event_awards_0) | **GET** /team/{team_key}/event/{event_key}/awards | 
[**get_team_event_matches_0**](EventApi.md#get_team_event_matches_0) | **GET** /team/{team_key}/event/{event_key}/matches | 
[**get_team_event_matches_keys_0**](EventApi.md#get_team_event_matches_keys_0) | **GET** /team/{team_key}/event/{event_key}/matches/keys | 
[**get_team_event_matches_simple_0**](EventApi.md#get_team_event_matches_simple_0) | **GET** /team/{team_key}/event/{event_key}/matches/simple | 
[**get_team_event_status_0**](EventApi.md#get_team_event_status_0) | **GET** /team/{team_key}/event/{event_key}/status | 
[**get_team_events_0**](EventApi.md#get_team_events_0) | **GET** /team/{team_key}/events | 
[**get_team_events_by_year_0**](EventApi.md#get_team_events_by_year_0) | **GET** /team/{team_key}/events/{year} | 
[**get_team_events_by_year_keys_0**](EventApi.md#get_team_events_by_year_keys_0) | **GET** /team/{team_key}/events/{year}/keys | 
[**get_team_events_by_year_simple_0**](EventApi.md#get_team_events_by_year_simple_0) | **GET** /team/{team_key}/events/{year}/simple | 
[**get_team_events_keys_0**](EventApi.md#get_team_events_keys_0) | **GET** /team/{team_key}/events/keys | 
[**get_team_events_simple_0**](EventApi.md#get_team_events_simple_0) | **GET** /team/{team_key}/events/simple | 
[**get_team_events_statuses_by_year_1**](EventApi.md#get_team_events_statuses_by_year_1) | **GET** /team/{team_key}/events/{year}/statuses | 



## get_district_events_0

> Vec<models::Event> get_district_events_0(district_key, if_none_match)
...
> Vec<String> get_district_events_keys_0(district_key, if_none_match)
...
> Vec<models::EventSimple> get_district_events_simple_0(district_key, if_none_match)
...
> Vec<models::Award> get_team_event_awards_0(team_key, event_key, if_none_match)
...
> Vec<models::Match> get_team_event_matches_0(team_key, event_key, if_none_match)
...
> Vec<String> get_team_event_matches_keys_0(team_key, event_key, if_none_match)
...
> Vec<models::Match> get_team_event_matches_simple_0(team_key, event_key, if_none_match)
...
> models::TeamEventStatus get_team_event_status_0(team_key, event_key, if_none_match)
...
> Vec<models::Event> get_team_events_0(team_key, if_none_match)
...
> Vec<models::Event> get_team_events_by_year_0(team_key, year, if_none_match)
...
> Vec<String> get_team_events_by_year_keys_0(team_key, year, if_none_match)
...
> Vec<models::EventSimple> get_team_events_by_year_simple_0(team_key, year, if_none_match)
...
> Vec<String> get_team_events_keys_0(team_key, if_none_match)
...
> Vec<models::EventSimple> get_team_events_simple_0(team_key, if_none_match)
...
> std::collections::HashMap<String, models::GetTeamEventsStatusesByYear200ResponseValue> get_team_events_statuses_by_year_1(team_key, year, if_none_match)
