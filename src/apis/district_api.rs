...
pub async fn get_team_districts_0(configuration: &configuration::Configuration, team_key: &str, if_none_match: Option<&str>) -> Result<Vec<models::DistrictList>, Error<GetTeamDistricts0Error>> {
    let local_var_configuration = configuration;
